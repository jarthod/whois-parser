...
#
#   /spec/fixtures/responses/whois.nic.systems/systems/status_available_premium.expected
#
...
describe "whois.nic.systems", :aggregate_failures do
  ...
  subject do
    file = fixture("responses", "whois.nic.systems/systems/status_available_premium.txt")
    part = Whois::Record::Part.new(body: File.read(file), host: "whois.nic.systems")
    Whois::Parser.parser_for(part)
  end

  it "matches status_available_premium.expected" do
