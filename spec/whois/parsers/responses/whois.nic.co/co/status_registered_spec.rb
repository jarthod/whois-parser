...
describe "whois.nic.co", :aggregate_failures do

  subject do
    file = fixture("responses", "whois.nic.co/co/status_registered.txt")
    part = Whois::Record::Part.new(body: File.read(file), host: "whois.nic.co")
  ...
  it "matches status_registered.expected" do
    ...
    expect(subject.created_on).to eq(DateTime.parse("2010-04-26 07:50:40 GMT"))
