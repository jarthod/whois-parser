...
describe "whois.usp.ac.fj", :aggregate_failures do

  subject do
    file = fixture("responses", "whois.usp.ac.fj/fj/status_registered.txt")
    part = Whois::Record::Part.new(body: File.read(file), host: "whois.usp.ac.fj")
