...
describe "whois.centralnic.com", :aggregate_failures do
  ...
  it "matches status_registered.expected" do
    ...
    expect(subject.domain).to eq("greenflame.ae.org")
    expect(subject.domain_id).to eq("D220363148-CNIC")
    expect(subject.status).to eq(:registered)
    expect(subject.available?).to eq(false)
    expect(subject.registered?).to eq(true)
    expect(subject.created_on).to be_a(Time)
    expect(subject.created_on).to eq(DateTime.parse("2021-02-04 08:51:08 UTC"))
    expect(subject.updated_on).to be_a(Time)
    expect(subject.updated_on).to eq(DateTime.parse("2021-03-24 15:08:42 UTC"))
    expect(subject.expires_on).to be_a(Time)
    expect(subject.expires_on).to eq(DateTime.parse("2022-02-04 23:59:59 UTC"))
    ...
    expect(subject.registrar.url).to eq("https://www.openprovider.com/")
    ...
    expect(subject.registrant_contacts[0].email).to eq("https://whois.centralnic.com/contact/greenflame.ae.org/registrant")
    ...
    expect(subject.admin_contacts[0].email).to eq("https://whois.centralnic.com/contact/greenflame.ae.org/admin")
    ...
    expect(subject.technical_contacts[0].email).to eq("https://whois.centralnic.com/contact/greenflame.ae.org/tech")
    expect(subject.nameservers).to be_a(Array)
    expect(subject.nameservers.size).to eq(2)
    expect(subject.nameservers[0]).to be_a(Whois::Parser::Nameserver)
    expect(subject.nameservers[0].name).to eq("ns1.dns-parking.com")
    expect(subject.nameservers[1]).to be_a(Whois::Parser::Nameserver)
    expect(subject.nameservers[1].name).to eq("ns2.dns-parking.com")
  end
end
