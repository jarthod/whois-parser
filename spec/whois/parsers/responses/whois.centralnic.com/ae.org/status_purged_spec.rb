...
#
#   /spec/fixtures/responses/whois.centralnic.com/ae.org/status_purged.expected
#
...
describe "whois.centralnic.com", :aggregate_failures do
  ...
  subject do
    file = fixture("responses", "whois.centralnic.com/ae.org/status_purged.txt")
    part = Whois::Record::Part.new(body: File.read(file), host: "whois.centralnic.com")
    Whois::Parser.parser_for(part)
  end

  it "matches status_purged.expected" do
