...
describe "capetown-whois.registry.net.za", :aggregate_failures do

  subject do
    file = fixture("responses", "capetown-whois.registry.net.za/capetown/status_available.txt")
    part = Whois::Record::Part.new(body: File.read(file), host: "capetown-whois.registry.net.za")
