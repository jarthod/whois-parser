...
describe "whois.nic.pm", :aggregate_failures do
  ...
  subject do
    file = fixture("responses", "whois.nic.pm/pm/status_registered.txt")
  ...
  it "matches status_registered.expected" do
    ...
    expect(subject.registrant_contacts[0].updated_on).to eq(DateTime.parse("2017-07-17 12:39:46 UTC"))
