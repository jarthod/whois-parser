...
describe "whois.educause.edu", :aggregate_failures do
  ...
  subject do
    file = fixture("responses", "whois.educause.edu/edu/property_contact_registrant_without_zip.txt")
    part = Whois::Record::Part.new(body: File.read(file), host: "whois.educause.edu")
    Whois::Parser.parser_for(part)
  end

  it "matches property_contact_registrant_without_zip.expected" do
