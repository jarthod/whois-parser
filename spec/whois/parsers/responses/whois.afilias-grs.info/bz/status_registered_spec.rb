...
describe "whois.afilias-grs.info", :aggregate_failures do
  ...
  it "matches status_registered.expected" do
    ...
    expect(subject.domain_id).to eq("D105800000000354967-AGRS")
    ...
    expect(subject.created_on).to eq(DateTime.parse("2006-02-12 18:08:52 UTC"))
    expect(subject.updated_on).to be_a(Time)
    expect(subject.updated_on).to eq(DateTime.parse("2021-01-11 10:34:48 UTC"))
    expect(subject.expires_on).to be_a(Time)
    expect(subject.expires_on).to eq(DateTime.parse("2022-02-12 18:08:52 UTC"))
