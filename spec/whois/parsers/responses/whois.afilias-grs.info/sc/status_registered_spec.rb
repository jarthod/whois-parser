...
describe "whois.afilias-grs.info", :aggregate_failures do
  ...
  it "matches status_registered.expected" do
    ...
    expect(subject.domain_id).to eq("D105800000000047234-AGRS")
    ...
    expect(subject.created_on).to eq(DateTime.parse("2004-02-03 19:19:12 UTC"))
    expect(subject.updated_on).to be_a(Time)
    expect(subject.updated_on).to eq(DateTime.parse("2021-01-02 10:34:05 UTC"))
    expect(subject.expires_on).to be_a(Time)
    expect(subject.expires_on).to eq(DateTime.parse("2022-02-03 19:19:12 UTC"))
