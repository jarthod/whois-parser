...
describe "whois.afilias-grs.info", :aggregate_failures do
  ...
  it "matches status_registered.expected" do
    ...
    expect(subject.domain).to eq("google.vc")
    expect(subject.domain_id).to eq("D105800000000133753-AGRS")
    ...
    expect(subject.created_on).to eq(DateTime.parse("2005-06-29 00:58:18 UTC"))
    expect(subject.updated_on).to be_a(Time)
    expect(subject.updated_on).to eq(DateTime.parse("2021-05-28 09:37:54 UTC"))
    expect(subject.expires_on).to be_a(Time)
    expect(subject.expires_on).to eq(DateTime.parse("2022-06-29 00:58:18 UTC"))
