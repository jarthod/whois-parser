...
describe "whois.dns.pt", :aggregate_failures do
  ...
  subject do
    file = fixture("responses", "whois.dns.pt/pt/status_registered.txt")
  ...
  it "matches status_registered.expected" do
    ...
    expect(subject.created_on).to eq(DateTime.parse("2003-01-09 00:00:00 UTC"))
    expect { subject.updated_on }.to raise_error(Whois::AttributeNotSupported)
    expect(subject.expires_on).to be_a(Time)
    expect(subject.expires_on).to eq(DateTime.parse("2015-02-28 00:00:00 UTC"))
