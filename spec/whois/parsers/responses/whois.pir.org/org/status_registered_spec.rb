...
describe "whois.pir.org", :aggregate_failures do
  ...
  subject do
    file = fixture("responses", "whois.pir.org/org/status_registered.txt")
  ...
  it "matches status_registered.expected" do
    ...
    expect(subject.created_on).to eq(DateTime.parse("1998-10-21 04:00:00 UTC"))
    expect(subject.updated_on).to be_a(Time)
    expect(subject.updated_on).to eq(DateTime.parse("2021-09-18 09:24:00 UTC"))
    expect(subject.expires_on).to be_a(Time)
    expect(subject.expires_on).to eq(DateTime.parse("2022-10-20 04:00:00 UTC"))
