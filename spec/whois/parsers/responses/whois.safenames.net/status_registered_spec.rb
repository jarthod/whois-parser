...
describe "whois.safenames.net", :aggregate_failures do

  subject do
    file = fixture("responses", "whois.safenames.net/status_registered.txt")
    part = Whois::Record::Part.new(body: File.read(file), host: "whois.safenames.net")
