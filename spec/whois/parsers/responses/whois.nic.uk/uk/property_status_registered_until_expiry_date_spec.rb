...
describe "whois.nic.uk", :aggregate_failures do
  ...
  subject do
    file = fixture("responses", "whois.nic.uk/uk/property_status_registered_until_expiry_date.txt")
    part = Whois::Record::Part.new(body: File.read(file), host: "whois.nic.uk")
    Whois::Parser.parser_for(part)
  end

  it "matches property_status_registered_until_expiry_date.expected" do
