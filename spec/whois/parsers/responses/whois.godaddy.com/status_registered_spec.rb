...
describe "whois.godaddy.com", :aggregate_failures do

  subject do
    file = fixture("responses", "whois.godaddy.com/status_registered.txt")
    part = Whois::Record::Part.new(body: File.read(file), host: "whois.godaddy.com")
  ...
  it "matches status_registered.expected" do
    ...
    expect(subject.created_on).to eq(DateTime.parse("1999-03-02 05:00:00 UTC"))
    expect(subject.updated_on).to be_a(Time)
    expect(subject.updated_on).to eq(DateTime.parse("2013-06-02 12:16:24 UTC"))
