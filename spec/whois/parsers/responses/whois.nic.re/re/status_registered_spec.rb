...
describe "whois.nic.re", :aggregate_failures do
  ...
  subject do
    file = fixture("responses", "whois.nic.re/re/status_registered.txt")
  ...
  it "matches status_registered.expected" do
    ...
    expect(subject.updated_on).to eq(DateTime.parse("2018-12-31 23:33:19 UTC"))
    ...
    expect(subject.registrant_contacts[0].updated_on).to eq(DateTime.parse("2017-07-17 12:40:19 UTC"))
