...
describe "whois.eu.org", :aggregate_failures do

  subject do
    file = fixture("responses", "whois.eu.org/eu.org/status_registered.txt")
    part = Whois::Record::Part.new(body: File.read(file), host: "whois.eu.org")
