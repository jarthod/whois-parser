...
describe "whois.na-nic.com.na", :aggregate_failures do

  subject do
    file = fixture("responses", "whois.na-nic.com.na/na/status_registered.txt")
    part = Whois::Record::Part.new(body: File.read(file), host: "whois.na-nic.com.na")
    Whois::Parser.parser_for(part)
  end

  it "matches status_registered.expected" do
    expect(subject.domain).to eq("google.na")
    expect(subject.domain_id).to eq("4100-CoCCA")
