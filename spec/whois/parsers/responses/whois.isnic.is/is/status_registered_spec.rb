...
describe "whois.isnic.is", :aggregate_failures do
  ...
  subject do
    file = fixture("responses", "whois.isnic.is/is/status_registered.txt")
  ...
  it "matches status_registered.expected" do
    ...
    expect(subject.created_on).to eq(DateTime.parse("2002-05-22"))
    expect { subject.updated_on }.to raise_error(Whois::AttributeNotSupported)
    expect(subject.expires_on).to be_a(Time)
    expect(subject.expires_on).to eq(DateTime.parse("2014-05-22"))
