...
describe "whois.eenet.ee", :aggregate_failures do

  subject do
    file = fixture("responses", "whois.eenet.ee/ee/status_registered.txt")
    part = Whois::Record::Part.new(body: File.read(file), host: "whois.eenet.ee")
