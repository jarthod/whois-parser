...
describe "whois.nic.ir", :aggregate_failures do

  subject do
    file = fixture("responses", "whois.nic.ir/ir/status_available.txt")
    part = Whois::Record::Part.new(body: File.read(file), host: "whois.nic.ir")
