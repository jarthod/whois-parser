...
describe "whois.nic.tr", :aggregate_failures do
  ...
  subject do
    file = fixture("responses", "whois.nic.tr/tr/status_registered.txt")
  ...
  it "matches status_registered.expected" do
    ...
    expect(subject.created_on).to eq(DateTime.parse("2001-08-23 00:00:00 UTC"))
    expect { subject.updated_on }.to raise_error(Whois::AttributeNotSupported)
    expect(subject.expires_on).to be_a(Time)
    expect(subject.expires_on).to eq(DateTime.parse("2014-08-22 00:00:00 UTC"))
