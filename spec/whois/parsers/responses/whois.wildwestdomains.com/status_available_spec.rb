...
describe "whois.wildwestdomains.com", :aggregate_failures do

  subject do
    file = fixture("responses", "whois.wildwestdomains.com/status_available.txt")
    part = Whois::Record::Part.new(body: File.read(file), host: "whois.wildwestdomains.com")
