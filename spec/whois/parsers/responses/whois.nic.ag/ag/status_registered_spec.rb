...
describe "whois.nic.ag", :aggregate_failures do

  subject do
    file = fixture("responses", "whois.nic.ag/ag/status_registered.txt")
    part = Whois::Record::Part.new(body: File.read(file), host: "whois.nic.ag")
  ...
  it "matches status_registered.expected" do
    ...
    expect(subject.domain).to eq("google.ag")
    expect(subject.domain_id).to eq("D105800000000048552-AGRS")
    ...
    expect(subject.created_on).to eq(DateTime.parse("2003-01-05 14:06:59 UTC"))
    expect(subject.updated_on).to be_a(Time)
    expect(subject.updated_on).to eq(DateTime.parse("2020-12-04 10:29:47 UTC"))
    expect(subject.expires_on).to be_a(Time)
    expect(subject.expires_on).to eq(DateTime.parse("2022-01-05 14:06:59 UTC"))
