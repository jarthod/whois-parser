...
describe "whois.za.net", :aggregate_failures do

  subject do
    file = fixture("responses", "whois.za.net/za.net/status_registered.txt")
    part = Whois::Record::Part.new(body: File.read(file), host: "whois.za.net")
  ...
  it "matches status_registered.expected" do
    ...
    expect(subject.nameservers[1].name).to eq("ns5.zoneedit.com")
  end
end
