...
describe "whois.nic.wf", :aggregate_failures do

  subject do
    file = fixture("responses", "whois.nic.wf/wf/status_registered.txt")
    part = Whois::Record::Part.new(body: File.read(file), host: "whois.nic.wf")
  ...
  it "matches status_registered.expected" do
    ...
    expect(subject.created_on).to eq(DateTime.parse("1994-12-31 23:00:00 UTC"))
    expect(subject.updated_on).to be_a(Time)
    expect(subject.updated_on).to eq(DateTime.parse("2018-12-31 23:33:39 UTC"))
    expect(subject.expires_on).to be_a(Time)
    expect(subject.expires_on).to eq(DateTime.parse("2019-12-31 23:00:00 UTC"))
    expect(subject.registrant_contacts).to be_a(Array)
    expect(subject.registrant_contacts.size).to eq(1)
    expect(subject.registrant_contacts[0]).to be_a(Whois::Parser::Contact)
    expect(subject.registrant_contacts[0].type).to eq(Whois::Parser::Contact::TYPE_REGISTRANT)
    expect(subject.registrant_contacts[0].id).to eq("AEFT2-FRNIC")
    expect(subject.registrant_contacts[0].name).to eq(nil)
    expect(subject.registrant_contacts[0].organization).to eq("Afnic (Wallis et Futuna - TOM)")
    ...
    expect(subject.registrant_contacts[0].updated_on).to eq(DateTime.parse("2017-07-17 12:41:18 UTC"))
    ...
    expect(subject.admin_contacts[0].updated_on).to eq(DateTime.parse("2005-08-23 16:13:17 UTC"))
    ...
    expect(subject.technical_contacts[0].updated_on).to eq(DateTime.parse("2005-08-23 16:13:17 UTC"))
